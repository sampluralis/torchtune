...
POST_TRAINED_CHECKPOINT = "/tmp/checkpoints/grpo_llama3b/epoch_0"
BASE_CHECKPOINT         = "/tmp/Meta-Llama-3.2-3B"
CONFIG_PATH            = "./llama-3_2-3b-generation.yaml"
...
def generate_from_two_models(prompt: str):
    ...
    return answer_post, answer_base
...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        prompt_in = gr.Textbox(
            ...
            placeholder="e.g. How many planets are in our solar system?"
        )
